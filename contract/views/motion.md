...
| --- | --- | --- | --- | --- | --- |
| N-01 | `/navigation/navigate_to_pose` | Action | `robot_navigation_interfaces/action/NavigateToPoseTask` | Autonomy | — |
...
| M-01 | `/motion/move_to_camera_view_pose` | Action | `robot_task_interfaces/action/MoveToCameraViewPose` | Autonomy | — |
| M-02 | `/motion/plan_and_execute_pick` | Action | `robot_task_interfaces/action/PlanAndExecutePick` | Autonomy | — |
| M-03 | `/motion/plan_and_execute_place` | Action | `robot_task_interfaces/action/PlanAndExecutePlace` | Autonomy | — |
